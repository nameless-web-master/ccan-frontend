    ...
    <section className="relative isolate overflow-hidden bg-black text-white">
      ...
      <div
        ...
        className="pointer-events-none absolute inset-0 z-10
          bg-[linear-gradient(90deg,rgba(0,0,0,0.82)_0%,rgba(0,0,0,0.6)_38%,rgba(0,0,0,0.24)_65%,rgba(0,0,0,0.08)_100%),linear-gradient(180deg,rgba(0,0,0,0.16)_0%,rgba(0,0,0,0)_30%,rgba(0,0,0,0)_65%,rgba(0,0,0,0.68)_100%)]
          max-md:bg-[linear-gradient(180deg,rgba(0,0,0,0.35)_0%,rgba(0,0,0,0)_35%,rgba(0,0,0,0)_60%,rgba(0,0,0,0.5)_100%)]"
      />

      <div className="container-page relative z-20 grid min-h-[640px] items-center py-24 max-md:min-h-[560px] max-md:py-16">
